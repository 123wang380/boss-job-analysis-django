...
class JobInfo(models.Model):
    ...
    pratice = models.BooleanField('是否为实习单位',default=False)
...
class User(models.Model):
    ...
    is_active = models.BooleanField("账号是否启用",default=True)
    createTime = models.DateField("创建时间",auto_now_add=True)
...
class LoginLog(models.Model):
    ...
    login_type = models.CharField('登录方式',max_length=20,default='password')  # password/phone
    class Meta:
        db_table = "login_log"
